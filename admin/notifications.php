							    ...
							    <div class="table-responsive p-2">
							        <table class="table table-striped app-table-hover mb-0 text-left" id='data'>
										...
										<tbody>
										    <?php
										    $index = 0;
										    $generated_query = gen_mul_team_query_without_where("SELECT * FROM `notification`", $active_team_array);
										    $activity_log = mysqli_query($conn, $generated_query." ORDER BY id DESC"); 

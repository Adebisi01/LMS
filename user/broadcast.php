							    ...
							    <div class="table-responsive p-2">
							        <table class="table table-striped app-table-hover mb-0 text-left" id='data'>
										...
										<tbody>
										    <?php
										    $index = 0;
										    $activity_log = mysqli_query($conn, "SELECT * FROM `broadcast` WHERE category='users' AND team LIKE '%$current_team_id%' ORDER BY id DESC");
											...
											<tr>
												...
												<td class="cell"><span><?=ucfirst(strtolower($subject))?></span></td>

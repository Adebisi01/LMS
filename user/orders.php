							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
										    ...
										    <?php 
										    $index = 0;
										    $request = mysqli_query($conn, "SELECT * FROM book_requests WHERE borrower_id = '$current_user_id'") ;
											...
											<tr>
												...
												<td class="cell"><span class="badge bg-danger"><?=$status?></span></td>
												<td class="cell"><span><?=$date?></span><span class="note">2:16 PM</span></td>
												<td class="cell"><button class='btn btn-success'>Button</button></td>
